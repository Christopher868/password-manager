...
export async function fetchAccounts(userId, accountsList){
    ...
    userAccounts.forEach((account) => {
        accountsList.innerHTML += `<a class="shadow-black hover:shadow-md hover:text-blue-400" href="#"><li class="account border py-2 px-4 truncate">${account.site} <i class="fa fa-angle-right"></i></li></a>`
    })
}